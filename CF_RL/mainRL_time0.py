...
# Training constants
BATCH_SIZE = 128
LATENT_DIM = 16 # 16 for Handoutlines, 64 for FordA and FordB, res still saved into rl_32_ela_final, the others should be 32
...
# Wandb configuration
WANDB_PROJECT = "RL-CF-final-50000-1-32-ela-binary-final"
...
def main():
    ...
    wandb.init(project=WANDB_PROJECT, entity="xxxx", name=f"CFRL_{args.dataset}")
